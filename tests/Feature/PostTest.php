...
class PostTest extends TestCase
{
    ...
    public function test_user_can_acsess_posts_index() {
    ...
    public function test_user_can_acsess_posts_show() {
        $user = User::factory()->create();
        $post = Post::factory()->create(['user_id' => $user->id]);
    ...
    public function test_user_can_acsess_posts_create() {
        $user = User::factory()->create();
    ...
    public function test_user_can_acsess_posts_store() {
        $user = User::factory()->create();
    ...
    public function test_user_cannot_acsess_orders_posts_edit() {
        $user = User::factory()->create();
        $order_user = User::factory()->create();
        $orders_post = Post::factory()->create(['user_id' => $order_user->id]);

        $response = $this->actingAs($user)->get(route('posts.edit', $orders_post));

        $response->assertRedirect(route('posts.index'));
    }

    // ログイン済みのユーザーは自身の投稿編集ページにアクセスできる
    public function test_user_can_acsess_own_posts_edit() {
        $user = User::factory()->create();
        $post = Post::factory()->create(['user_id' => $user->id]);
    ...
    public function test_user_cannot_update_others_post() {
        $user = User::factory()->create();
        $order_user = User::factory()->create();
        $order_old_post = Post::factory()->create(['user_id' => $order_user->id]);
        ...
        $response = $this->actingAs($user)->patch(route('posts.update', $order_old_post), $new_post);
